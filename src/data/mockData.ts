...
export const MOCK_LIKED_BY: LikedByUser[] = [
  {
    ...
    zodiacSign: "Aslan",
    interests: ["Fine Dining Kaşifliği", "Yelkencilik", "Bienal & Art Week"],
    vibeTags: ["Eğlenceli", "Yaratıcı", "Saygılı"],
    compatibilityScore: 91,
    profession: "Fotoğrafçı",
    musicTaste: ["Indie", "Elektronik", "R&B"],
    averageRating: 4.8,
    ratingCount: 52,
    lookingFor: ["dating", "friendship"],
    bio: "Işığı ve anı yakalamanın peşindeyim. Sanat ve macera bir arada olunca hayat güzel.",
  },
  {
    id: "l2",
    name: "Aurora",
    ...
    zodiacSign: "Balık",
    interests: ["Specialty Coffee", "Bağımsız Sinema", "Kitap Koleksiyonculuğu"],
    vibeTags: ["Düşünceli", "Nazik", "Entelektüel"],
    compatibilityScore: 83,
    profession: "Editör",
    musicTaste: ["Jazz", "Klasik Müzik", "Lo-fi / Chill"],
    averageRating: 4.3,
    ratingCount: 18,
    lookingFor: ["networking", "friendship"],
    bio: "Kelimelerle yaşıyorum; bir roman, iyi kahve ve sessiz bir köşe bana yeter.",
  },
  {
    id: "l3",
    name: "Leila",
    ...
    zodiacSign: "Terazi",
    interests: ["Reformist Pilates", "Omakase Deneyimi", "Padel Tenis"],
    vibeTags: ["Hırslı", "Maceracı", "Enerjik"],
    compatibilityScore: 76,
    profession: "Girişimci",
    musicTaste: ["Pop", "Türkçe Pop", "House"],
    averageRating: 4.6,
    ratingCount: 31,
    lookingFor: ["dating"],
    bio: "Hem iddialı hem de eğlenceli biri arıyorum. Spor ve gastronomi benim için ayrılmaz ikilisi.",
  },
];
